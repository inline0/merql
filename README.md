<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./docs/public/logo-dark.svg?v=1">
    <source media="(prefers-color-scheme: light)" srcset="./docs/public/logo-light.svg?v=1">
    <img alt="Merql" src="./docs/public/logo-light.svg?v=1" height="56">
  </picture>
</p>
